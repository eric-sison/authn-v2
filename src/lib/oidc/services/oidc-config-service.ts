...
export class OIDCConfigService {
  ...
  private validateConfiguration() {
    ...
    if (!this.isValidUrl(this.config.issuer)) {
    ...
    if (!this.isValidUrl(this.config.authorizationEndpoint)) {
    ...
    if (!this.isValidUrl(this.config.tokenEndpoint)) {
    ...
    if (!this.isValidUrl(this.config.userinfoEndpoint)) {
    ...
    if (!this.isValidUrl(this.config.jwksUri)) {
